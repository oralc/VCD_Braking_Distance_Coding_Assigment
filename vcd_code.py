...
#runfile('vcd_code.py', '--initial_velocity_kmh 50 --mass 1100 --road_type concrete --weather dry --angle 0')
...
#Set up argparser
#Note: Angle of the incline: Positive for uphill || Negative for downhill)   
